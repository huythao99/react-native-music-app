...
export default function PlayListScreen({ route, navigation }: MyPlayListProps) {
  ...
  const onPressConfirmButton = async () => {
    if (itemSelect?.items?.includes(route.params.trackId)) {
      Alert.alert('Thông báo', 'Bài hát đã tồn tại trong danh sách');
    } else {
  ...
  return (
    <View
      ...
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerText}>Tạo Playlist</Text>
      </View>
      <FlatList
